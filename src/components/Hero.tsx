    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 text-center pb-24">
        ...
        <motion.h1
          ...
          className="font-display font-extrabold text-[1.75rem] leading-[1.2] xs:text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl sm:leading-tight mb-4 sm:mb-6 text-balance"
        >
