...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 right-1/4 w-[400px] h-[400px] bg-stellar-blue/8 rounded-full blur-[100px]" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pb-24">
        ...
        >
          <a
            href="#contato"
            className="group px-8 py-4 rounded-full bg-gradient-to-r from-electric-violet to-stellar-blue text-white font-semibold text-lg flex items-center gap-3 hover:shadow-[0_0_40px_rgba(139,92,246,0.5)] transition-all duration-300 hover:scale-105"
          >
          ...
          <a
            href="#servicos"
            className="group px-8 py-4 rounded-full border border-white-dim/30 text-starlight font-medium text-lg flex items-center gap-3 hover:border-electric-violet/60 hover:bg-electric-violet/5 transition-all duration-300"
          >
        ...
        {/* Stats - removido temporariamente */}
      </div>
